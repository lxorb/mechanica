...
| **0:20–0:35** | pick up the phone, type `mt-07`, tap the **YAMAHA MT-07** card, tap **2018**, confirm. A progress bar starts. **Leave it running.** | a bar filling | "Hold that thought — I've just asked it for a manual it has never seen. We'll come back to it." | *Something is loading. Fine.* |
