...
| 5 | **The metrics that moved** | cycle time **5 min → 2 s** (p95 3.33 s) · error rate **100% top-1 / 150**, **0 of 20** off-topic answered, **0** invented numbers · unit cost **$0.0006 vs $12.40** · **543 manuals, 97,230 pages, $13.80 spent** | — |
...
vehicles: 543 manuals cost about $52 total, once, shared by everyone, and the whole free-and-
