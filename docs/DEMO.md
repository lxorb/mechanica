...
| 0:15–0:25 | Back to the landing, type `390 duke`, tap the card, tap **2024** | model cards with photos, year chips, then Confirm | "So we never let it answer. Pick your exact bike — 27,751 of them: 23,140 motorcycles and 4,611 cars." |
...
| 1:55–2:15 | Back to the landing → the MT-07 is **ready** → Pick → type `oil` → Open | p.58–60 *Engine oil and oil filter cartridge* | "That manual did not exist on our servers two minutes ago. Any of 14,770 free official manuals, fetched, parsed and searchable in under a minute, for ten cents." |
...
| **On-demand stalls past ~60 s** | Back out and use the MT-07 **2019** or **2020** — both warm. Say "we already have 535 of these cached; that one was a cold fetch." |
